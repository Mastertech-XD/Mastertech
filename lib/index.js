...
async function addWelcome(jid, enabled, message) {
    try {
        ...
        data.welcome[jid] = {
            enabled: enabled,
            message: message || '╔══✦🎪━━━━━━━━🎪✦══╗🏰  𝗪𝗘𝗟𝗖𝗢𝗠𝗘  🏰  ╚══╔══✦🎪━━━━━━━━🎪✦══╗ 🏰 𝗪𝗘𝗟𝗖𝗢𝗠𝗘 🏰 ╚══✦🎪━━━━━━━━🎪✦══╝ ╭──────────────────╮ │ 🎭 𝗡𝗲𝘄 𝗠𝗲𝗺𝗯𝗲𝗿: {user} │ 🏛️ 𝗚𝗿𝗼𝘂𝗽: {group} ╰──────────────────╯ ╭──────────────────╮ │ ✨ 𝗪𝗲𝗹𝗰𝗼𝗺𝗲 𝗠𝗲𝘀𝘀𝗮𝗴𝗲: │ "{welcome_msg}" ╰──────────────────╯ ╔══✦🎪━━━━━━━━🎪✦══╗ 🎉 𝗘𝗻𝗷𝗼𝘆 𝘆𝗼𝘂𝗿 𝘀𝘁𝗮𝘆! ╚══✦🎪━━━━━━━━🎪✦══╝✦🎪━━━━━━━━🎪✦══╝╭──────────────────╮│  🎭  𝗡𝗲𝘄 𝗠𝗲𝗺𝗯𝗲𝗿: {user}  │  🏛️  𝗚𝗿𝗼𝘂𝗽: {group}  ╰──────────────────╯╭──────────────────╮│  ✨ 𝗪𝗲𝗹𝗰𝗼𝗺𝗲 𝗠𝗲𝘀𝘀𝗮𝗴𝗲:  │  "{welcome_msg}"  ╰──────────────────╯╔══✦🎪━━━━━━━━🎪✦══╗🎉 𝗘𝗻𝗷𝗼𝘆 𝘆𝗼𝘂𝗿 𝘀𝘁𝗮𝘆!  ╚══✦🎪━━━━━━━━🎪✦══╝',
...
async function addGoodbye(jid, enabled, message) {
    try {
        ...
        data.goodbye[jid] = {
            enabled: enabled,
            message: message || '╔═⚔️ NOBLE RETREAT ⚔️═╗ ║ 👑 Knight: {user} ║ 🏛️ Court: {group} ╠═══════════════╣ ║ 🏆 Message: ║ "Your seat at the round table remains!" ╚═══════════════╝',
            channelId: '120363161513685998@newsletter'
        };
